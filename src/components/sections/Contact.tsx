...
import { Phone, Mail, MapPin, MessageCircle, Send, ArrowRight, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    <section id="iletisim" className="bg-white py-24 md:py-32">
      <div className="container-edge">
        ...
        <div className="grid lg:grid-cols-5 gap-5 md:gap-6">
          {/* Info column — düz, dekorsuz */}
          <div className="lg:col-span-2 space-y-4">
            <a href={`tel:${SITE.phone1Tel}`} className="block rounded-3xl bg-gradient-brand text-white p-7 shadow-brand">
              <div className="flex items-center gap-2.5">
                <div className="h-10 w-10 rounded-xl bg-cta text-cta-foreground flex items-center justify-center">
              ...
              <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold opacity-90">
            ...
            <a
              ...
              className="block rounded-3xl bg-whatsapp text-whatsapp-foreground p-7 shadow-md"
            >
              <div className="flex items-center gap-2.5">
            ...
            <div className="rounded-3xl bg-surface border border-slate-200 p-6 space-y-5">
              ...
              <div className="flex items-start gap-3 pt-5 border-t border-slate-200">
                ...
                <div>
                  ...
                  <a href={`mailto:${SITE.email}`} className="mt-1.5 block text-sm text-ink font-medium hover:text-brand">
                    {SITE.email}
                  </a>
                </div>
              </div>
          ...
          {/* Form column — minimal, dekorasız */}
          <form
            onSubmit={onSubmit}
            className="lg:col-span-3 rounded-3xl bg-white border border-slate-200 p-7 md:p-9 shadow-lg"
          >
            ...
            <div className="mt-7 grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  name="name"
                  placeholder="Adınız"
                  className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand"
                />
              </div>
              <div>
              ...
              <div className="sm:col-span-2">
                ...
                <select
                  ...
                  name="service"
                  defaultValue=""
                  className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand cursor-pointer"
                >
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand resize-none"
                />
              </div>
            ...
            <button
              ...
              className="mt-6 w-full inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-cta text-cta-foreground px-6 py-4 text-base font-semibold shadow-cta disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {status === "submitting" ? (
                <>
              ...
              <div className="mt-4 rounded-xl bg-green-50 border border-green-200 p-4">
                ...
                {waFallbackUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 inline-flex items-center gap-2 rounded-xl bg-whatsapp text-whatsapp-foreground px-4 py-2.5 text-[13px] font-semibold hover:bg-whatsapp-deep"
                  >
